    ...
    <div className="flex items-center justify-between py-4">
      <div className="relative w-full max-w-md">
        <Input
          ...
          className="pl-4 pr-10 py-2 rounded-md bg-gray-50 border-gray-200"
        />
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <div className="absolute rounded-lg -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-xs bg-black text-white">
            2
          </div>
        </div>
